...
Before the drone can execute the path planning algorithm, it must determine the 3D coordinates of the four window corners ($E1, E2, E3, E4$) in the local NED (North-East-Down) frame.
...
- The unit vectors for the window's World Frame are established:
  - **$X_w$:** Along the bottom edge of the window (e.g., $E2 - E1$).
  - **$Z_w$:** Along the left edge of the window (e.g., $E1 - E4$).
